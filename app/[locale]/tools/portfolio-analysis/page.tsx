...
const TOOL_URL = "https://humble-beauty-production-82c1.up.railway.app/Portfolio_Analysis?embed=true&embed_options=show_sidebar";
    ...
    <main className="min-h-screen bg-[#0a0f1e] text-white flex flex-col">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "description": "Analyse your investment portfolio — allocation, performance, risk, and diversification. Free, no signup.",
      ...
      <div className="fixed top-[65px] left-0 right-0 z-40 bg-[#0d1426]/95 backdrop-blur border-b border-gray-800 px-6 py-3">
        <div className="max-w-7xl mx-auto flex items-center gap-3">
          ...
          <h1 className="text-white font-bold">📊 {tn("portfolioAnalysis")}</h1>
